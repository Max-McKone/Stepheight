...
export default function KickingBrassContent() {
    ...
    return (
        <div id='KB_Canvas' className='kb_canvas'>
            <Banner
                imageSrc1={kb_banner}
                imageSrc2={kb_logo}
            />
...
function AboutTab() {
    return (
        <div id='KB_AboutTab' className='TabContainer'>
...
function DownloadTab() {
    ...
    return (
        <div id='KB_DownloadTab' className="TabContainer">

            <div className='TabElement'>
                <h1>PLAYTEST ON STEAM!</h1>

                <iframe src="https://store.steampowered.com/widget/2657210/" frameborder="0" width="100%" height="190" title='Steam Downloader'></iframe>

                <h2>OR</h2>

                <p>Check out the <a href={urlKB_Archive}>KB Archive</a> for old versions of the game drm free </p>
...
function TutorialTab() {
    return (
        ...
        <div id='KB_TutorialTab' className="TabContainer">

            <div className="TabElement">
                <h1>CONTROLS</h1>
                <div className='TabElementLeft'>
                    <p>[W] - Move Forward</p>
                    <p>[A] - Move Left</p>
                    <p>[S] - Move Backward</p>
                    <p>[D] - Move Right</p>
                    <p>[Space] - Jump Up and Down</p>
                    <p>[Double tap Directional Input] - Short Slide in direction</p>
                    <p>[Cursor] - Aim</p>
                    <p>[Ctrl] - Camera to Cursor</p>
                    <p>[LMB] - Primary Attack</p>
                    <p>[RMB] - Secondary Attack</p>
                    <p>[I] - Toggle Inventory</p>
                    <p>[Space + Directional Input] - Jump Roll in direction</p>
                    <p>[F] - Interact</p>
                    <p>[Scroll Up] - Next Instrument</p>
                    <p>[E] - Next Instrument</p>
                    <p>[Scroll Down] - Prev Instrument</p>
                    <p>[Q] - Prev Instrument</p>
                    <p>[1] [2] [3] - Use Item</p>
                    <p>[Esc] - Toggle Menu</p>


                </div>
                <div className='TabElementRight'>
            ...
            <div className='TabElement'>
                <h1> THATS A LOT OF DAMAGE !</h1>

                <div className='TabElementLeft'> <p>
...
function GlossaryTab() {
    return (
        ...
        <div id='KB_GlossaryTab' className="TabContainer">
            <div className='TabElement'>
                <h1> GLOSSARY</h1>
            </div>
            ...
            <div className='TabElement' >
                ...
                {[
                    ...
                    <Card key={item.name + index} className='Items-card' sx={{ mt: 2, mb: 2 }}>
                        <CardContent>
                            <Grid container spacing={2} alignItems="center">
                                <Grid item xs={12} sm={6} md={6} lg={6} order={{ xs: 1, md: index % 2 === 0 ? 1 : 2 }}>
                                    <img src={item.image} alt={item.name} className='glossary-image' />
